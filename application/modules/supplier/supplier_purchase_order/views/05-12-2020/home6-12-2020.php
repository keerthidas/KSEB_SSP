                            ...
                            <tr>
                                ...
                                <th scope="col">Purchase Date</th>
								 <th scope="col">Action</th>
                                    ...
                                    <td>Tender name1</td>
                                    <td>27-11-2020</td>
                                    <td><div class="col-md-2 col-sm-3"><button  data-toggle="modal" data-target="#myModal_vmi" style="width:122px; height:33px;color: #fff;background-color: #1e315d; border-color: #ffcc33;">VMI</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="tg-ticket">
				...
				<b>Delivery Date</b>:29 November 20202<br>
        ...
        <table class="table">
			...
			<tbody>
				<tr>
					...
					<td>1000</td>
					<td>Clearance</td>
                    <td><button  data-toggle="modal" data-target="#schedule" style="width:66px;color: #fff;background-color: #1e315d; border-color: #ffcc33;">Schedule</button></td>
...
<div class="modal fade" id="schedule">
	...
	<button type="button" style="margin-right: 252px;" class="btn btn-danger" onclick="">Close</button>
            </div>
