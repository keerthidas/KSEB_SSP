						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<tr>
									...
									<td>MSR56/098</td>
								  <td>26/08/2020</td>
	<td><button style="width:87px;height:33px;color: #fff;background-color: #1e315d; border-color: #ffcc33;" data-toggle="modal" data-target="#notification" class="btn btn-primary btn-xs">Acceptance</button></td>
</td>
								</tr>
							</tbody>
						</table>
