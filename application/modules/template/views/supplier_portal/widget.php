    ...
    <div class="tab-content mt-3">
        ...
        <br>
                ...
                <a href="#" class=""><b>Administration</b></a><hr>
                        ...
                        <a href="<?=supplier_url('dashboard/profile')?>" style="<?php if($user_type=='2') echo "display: none;" ?>">Company Profile</a>
                        <a href="<?=supplier_url('dashboard/banking')?>">Banking Details</a>
                        <a href="<?=supplier_url('dashboard/manage_user')?>" style="<?php if($user_type=='2') echo "display: none;" ?>">Employees<i></i></a>
                        <a href="<?=supplier_url('dashboard/attachments')?>">Attachments</a>
                        <a href="<?=supplier_url('dashboard/portfolio')?>" style="<?php if($user_type=='2') echo "display: none;" ?>">Company Portfolio</a>
